...
#define CSN_LOW         GPIO_WriteLow(GPIOC, GPIO_PIN_4)
#define CSN_HIGH        GPIO_WriteHigh(GPIOC, GPIO_PIN_4)
#define CE_LOW          GPIO_WriteLow(GPIOC, GPIO_PIN_3)
#define CE_HIGH         GPIO_WriteHigh(GPIOC, GPIO_PIN_3)
